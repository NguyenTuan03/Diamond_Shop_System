  ...
  return (
    ...
    >
      <Box border={"1px solid #00000036"} padding={"70px 80px"}>
        ...
        <Text fontSize={"2xl"}>
          Please click here to check your inbox to validate your account.
        </Text>
        <Link to={"https://mail.google.com/mail/u/1/#inbox"} target="_blank">
          <Text fontSize={"lg"} mb={"14px"} fontWeight={"bold"} _hover={{color:"blue.400"}}>
            Go to you email
          </Text>
        </Link>
