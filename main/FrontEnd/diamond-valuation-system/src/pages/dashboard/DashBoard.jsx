...
export default function DashBoardAppoint() {
    ...
    const fetchTotalIncome = async () => {
        await axios
            .get(
                `${import.meta.env.VITE_REACT_APP_BASE_URL}/api/payment/income`
            )
            .then((res) => {
                setIncome(res.data);
            });
    ...
    return (
        <>
                        ...
                        >
                            ...
                            >
                                <HStack spacing={4} align="center">
                                    ...
                                    <Box>
                                        <Text color="blue.600">
                                            Round · 0.33 Carat · J Color
                                        </Text>
                                        <Text color="blue.600">
                                            VS1 Clarity · None Fluor
                                        </Text>
            ...
            <Stack direction={"row"} alignItems={"center"} mt={"100px"}>
