      ...
      >
        ...
        <Flex direction="column" w={"50vw"} gap={3}>
          <Text fontSize="lg">
            ...
            one-carat diamond is 0.20 grams, and a five-carat diamond is one
            gram. The carat weight plays no role in determining the beauty and
          ...
          <Text fontSize="lg" fontStyle="italic">
            ...
            choose the largest diamond carat weight that still fits within your
            budget. Some salespeople might try to push “only the best” on you.
            Keep in mind that if you follow that route, you may end up with a{" "}
            <LinkCharkaUI
              color={"red.400"}
          ...
          <Text fontSize="lg">
            ...
            For example, a round diamond’s diameter of 9.00mm to carat is 2.75ct
            on average.
          </Text>
          <TableContainer>
          ...
          <Text fontSize="lg">
            ...
            carat doesn't tell you exactly how big or small it is - though there
            is a correlation. As{" "}
            <LinkCharkaUI
              color={"blue.400"}
          ...
          <Text fontSize="lg">
            ...
            price. And where do you find the actual diamond carat weight? That’s
            where a
            <LinkCharkaUI
              color={"blue.400"}
          ...
          <Text fontSize="lg">
            For a round diamond, that’s the diameter, and for other shapes, it’s
            a function of length and width. For simplicity’s sake, for the rest
            of this article, I will refer to diameter, but what I am writing
            applies equally to non-round shapes.
          </Text>
          <Text fontSize="lg" fontWeight={"bold"} m={"20px 0 0 0"}>
          ...
          <Text fontSize="lg">
            ...
            important part of picking out a diamond. In our opinion, a
            ...
            microscope or loupe), but the typical person can’t see the inclusion
          ...
          <Text fontSize="lg">
            ...
            the diamond is very dark in the middle and has a diameter of 6.73mm.
          </Text>
          <Text fontSize="lg">
          ...
          <Text fontSize="lg">
            A half carat diamond is usually 5.1mm in diameter. That is 1/5th of
            an inch. To compare that, a one carat diamond is 6.4mm. So while the
            one carat is double the weight, the face of the half carat diamond
            is only 21% smaller.
          </Text>
          <Image />
          <LazyLoadImage
          ...
          <Text fontSize="lg">
            ...
            going to pay, what you should really be focusing on is the diamond
            cut and diameter.
          </Text>
          <Text fontSize="lg">
