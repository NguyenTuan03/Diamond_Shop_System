    ...
    <>
      ...
      >
        ...
        <Flex direction="column" w={"50vw"} gap={3}>
          ...
          <Text fontSize="lg">
            The term “diamond shape” refers the the geometric characteristics of
            a diamond. There are two major groups for diamond shapes: Round
            diamonds and fancy shapes diamonds. Round shape, or round brilliant
            cut, is the most popular and traditional cut by a considerable
            margin. That is why round shapes have always been their own
            category.
          </Text>
          <Text fontSize="lg">
            ...
            disadvantages, from its appearance and brilliance to the diamond
            price per carat.
          </Text>
          <Box
          ...
          >
            <Text fontSize="lg">
              ...
              round brilliant. These geometric works of art are created by
              diamond cutters who are master craftsmen with a cutting wheel.”{" "}
              <LinkCharkaUI
                color={"blue.400"}
          ...
          <Text fontSize="lg">
            ...
            is. This is a bit confusing. The reason for this is that each shape
            has a technical name that has the word cut in it (e.g. round
          ...
          <Text fontSize="lg">
            ...
            figure of the diamond. For example, pear shaped, round brilliant and
            cushion all refer to the actual shape and appearance of the diamond.
          </Text>
          <Text fontSize="lg">
            Our diamond shapes guide will help you maximize your budget with
            your desired taste and style. With these notes in mind, you can
          ...
          <Text fontSize="lg">
            ...
            the length of the diamond by the width. For example, if a diamond
            has a length of 5mm and a width of 3mm, the length to width ratio is
            1.67.
          </Text>
          <Text fontSize="lg">
          ...
          >
            <Text fontSize="lg">
              ...
              blemishes. Diamonds without these birthmarks are rare, and rarity
              affects a diamond’s value. Using the GIA International Diamond
              Grading System™, diamonds are assigned a clarity grade that ranges
          ...
          <Text fontSize="lg">
            ...
            inclusions better than others, allowing you to go with a lower
            clarity grade, without sacrificing quality.
          </Text>
          <Text fontSize="lg">
            Brilliant cuts, such as round, cushion, radiant, oval and pear
            shaped diamonds, all hide inclusions well, which may allow you to go
            as low as SI1 or SI2.
          </Text>
          <Text fontSize="lg">
            Princess cut diamonds, too, hide inclusions well, but with this
            shape you need to ensure that it doesn’t have any inclusions in its
            corners, as this can cause the diamond to chip if it knocks on
            something.
          </Text>
          ...
          <Text fontSize="lg">
            ...
            diamond shape for you depends on your personal tastes, preferences
            and budget.
          </Text>
          <Text fontSize="lg">
            The round brilliant cut offers the greatest level of brilliance and
            fire, meaning it tends to shine more than other diamond cuts.
          ...
          <Text fontSize="lg">
            ...
            often look larger than they are, meaning they offer a good
            combination of brilliance and value for money. Shapes like the
            princess cut are also a great value for money buy if you want to get
            the most carats for your budget.
          </Text>
          <Text fontSize="lg">
          ...
          <Text fontSize="lg">
            ...
            another shape, so it’s not like diamond cut where you might put your
            budget towards the highest grade possible.
          </Text>
          <Text fontSize="lg" fontWeight={"bold"}>
          ...
          <Text fontSize="lg">
            ...
            facets, the round brilliant cut is actually designed specifically to
          ...
          <Text fontSize="lg">
            <strong>Radiant cut</strong>. As its name suggests, the radiant cut
            is extremely brilliant, especially when exposed to light. A radiant
            cut diamond has 70 facets, allowing it to take in and reflect an
          ...
          <Text fontSize="lg">
            ...
            This gives this shape a lot of brilliance and fire when it’s cut
            well. As an extra bonus, a cushion cut diamond is usually less
          ...
          <Text fontSize="lg">
            ...
            shape, it also looks larger than other diamonds of an equivalent
            carat weight.
          </Text>
          <Text fontSize="lg">
            <strong>Oval cut</strong>. Oval diamonds offer similar brilliance
            and fire to the round brilliant cut. Due to their shape, diamonds in
            this cut can also appear larger than others.
          </Text>
          <Text fontSize="lg">
          ...
          <Text fontSize="lg">
            ...
            diamond’s shape if you’re looking for a lot of fire and brilliance.
            While shape plays an important role, it’s not the only factor that
            determines how much light a diamond will reflect.
          </Text>
          <Text fontSize="lg" fontWeight={"bold"}>
          ...
          <Text fontSize="lg">
            ...
            brilliant cut, only about 40% of the original rough diamond is left
            in the finished diamond. In other words, around 60% of the rough
            diamond is wasted.
          </Text>
          <Text fontSize="lg">
            As we’ve covered in our guide to the most affordable diamond shapes,
            the most affordable diamond shapes are usually those that use a
            large amount of the original rough diamond. These include the:{" "}
            <strong>
          ...
          <Text fontSize="lg">
            ...
            This means that you might need to buy a diamond with a higher color
            or clarity grade than you would for a round brilliant cut, negating
            some of the value for money factor.
          </Text>
          <Text fontSize="lg" fontWeight={"bold"}>
          ...
          <Text fontSize="lg">
            This is occasionally referred to as “face-up size,” since it refers
            to the total area of the diamond that’s visible when it’s set in a
          ...
          <Text fontSize="lg">
            ...
            what’s right for you or your loved one from a variety of options.
            Feel free to use this diamond shapes guide as you search for
            diamonds on the internet or in stores.
          </Text>
          <Text fontSize="lg">
            In the end, it’s most helpful to consider the unique person, style
            and occasion for which you are purchasing the diamond. For example,
            if it’s for an engagement ring, you’ll want to make sure your
