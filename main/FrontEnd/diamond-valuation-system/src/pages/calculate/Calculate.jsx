    ...
    return (
        ...
        >
            ...
            <Text fontSize="xl" fontStyle={"italic"}>
                Use our free diamond price calculator to valuate the current
                price for diamonds.
            </Text>
                        ...
                        <Grid templateColumns={"repeat(4, 1fr)"} gap={2}>
                            {clarityLabel.map((clarity, index) => (
                                <Button
                                    ...
                                    boxShadow="xl"
                                    backgroundColor={
                                        clarityActiveButtonIndex === index
                                            ? "blue.400"
                                            : "initial"
                                    }
                                    _hover={{ bg: "blue.400" }}
                                    onClick={() =>
                                        handleClick("clarity", index)
                                    }
                                >
