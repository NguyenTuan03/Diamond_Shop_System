export const shapeForm = [
  {
    title: "1. Round Brilliant Cut Diamonds",
    image: "https://www.diamonds.pro/wp-content/uploads/2021/01/Round-cut.jpg",
    description:
    ...
    sampleCostPrice: "2,810",
  },
  {
    title: "2. Princess Cut Diamond",
    image:
    ...
    sampleCost: "based on a 1.01 carat well cut, I color and a VVS2 clarity",
    sampleCostPrice: "3,410",
  },
  {
    title: "3. Emerald Cut Diamond",
    image:
    ...
    sampleCost: "based on a 1.01 carat well cut, I color and a VVS1 clarity",
    sampleCostPrice: "3,200",
  },
  {
    title: "4. Cushion Cut Diamond",
    image:
    ...
    sampleCost: "based on a 1.00 carat well cut, E color and a VS2 clarity",
    sampleCostPrice: "4,450",
  },
  {
    title: "5. Asscher Cut Diamond",
    image:
    ...
    sampleCost: "based on a 1.01 carat well cut, I color and a VVS1 clarity",
    sampleCostPrice: "2,780",
  },
  {
    title: "6. Pear Shaped Diamond",
    image:
    ...
    lengthToWidthRatio:
      "A 1.45-1.75 ratio is ideal for the pear shaped diamond.",
    proTip:
    ...
    sampleCost: "based on a 1.01 carat well cut, E color and a SI1 clarity",
    sampleCostPrice: "4,210",
  },
  {
    title: "7. Oval Diamond",
    image:
    ...
    sampleCost: "based on a 1.00 carat well cut, E color and a SI1 clarity",
    sampleCostPrice: "4,400",
  },
  {
    title: "8. Heart Shaped Diamond",
    image:
    ...
    sampleCost: "based on a 1.01 carat well cut, H color and a VS2 clarity",
    sampleCostPrice: "3,920",
  },
  {
    title: "9. Radiant Cut Diamond",
    image:
    ...
    sampleCost: "based on a 1.02 carat well cut, H color and a VS1 clarity",
    sampleCostPrice: "3,330",
  },
  {
    title: "10. Marquise Diamond",
    image:
    ...
    sampleCost: "based on a 1.03 carat well cut, H color and a VS1 clarity",
    sampleCostPrice: "4,730",
  },
  {
    title: "11. Baguette Diamond",
    image:
    ...
    sampleCost: "based on a 1.0 carat well cut, G color and a VS1 clarity",
    sampleCostPrice: "3,200",
  },
  {
    title: "12. Trillion Diamond",
    image:
    ...
    sampleCost: "based on a 1.0 carat well cut, G color and a VS1 clarity",
    sampleCostPrice: "5,180",
  },
];
export const shapeBottomLineRec =
...
export const shapeBottomLineRecWhatToLookFor = [
...
export const shapeBottomLineRecWhatToAvoid = [
