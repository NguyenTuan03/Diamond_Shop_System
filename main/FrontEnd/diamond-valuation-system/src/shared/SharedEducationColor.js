export const colorSlider = [
  {
    type: "D",
    title: "D Color Diamonds (Absolutely Colorless)",
    content:
  ...
  {
    type: "E",
    title: "E Color Diamond (Colorless)",
    content:
  ...
  {
    type: "F",
    title: "F Color Diamond (Colorless)",
    content:
  ...
  {
    type: "G",
    title: "G Color Diamond (Near Colorless)",
    content:
  ...
  {
    type: "H",
    title: "H Color Diamond (Near Colorless)",
    content:
  ...
  {
    type: "I",
    title: "I Color Diamond (Near Colorless)",
    content:
  ...
  {
    type: "J",
    title: "J Color Diamond (Near Colorless)",
    content:
      "J color diamonds look mostly colorless to the naked eye, but usually",
    image:
      "https://www.diamonds.pro/wp-content/uploads/2023/08/ColorSlider_J.jpeg",
  },
  {
    type: "K",
    title: "K Color Diamond (Faint)",
    content:
  ...
  {
    type: "L",
    title: "L Color Diamonds (Faint to Light Color)",
    content:
    ...
    image: "https://www.diamonds.pro/wp-content/uploads/2023/08/M.jpg",
  },
  {
    type: "M",
    title: "M Color Diamonds (Faint to Light Color)",
    content:
    ...
    image: "https://www.diamonds.pro/wp-content/uploads/2023/08/M-1.jpg",
  },
  {
    type: "N-Z",
    title: "N-Z Color Diamonds (Faint to Light Color)",
    content:
    ...
    image: "https://www.diamonds.pro/wp-content/uploads/2023/08/N-Z.jpg",
  },
];
export const colorTable = [
  {
    type: "D",
    description:
      "D is the highest color grade, meaning it has nearly no color. Under magnification and to the naked eye, a D color diamond will appear colorless.<br/><br/> D color diamonds are usually set in platinum or white gold, as yellow gold and other jewelry settings detract from the diamond’s uncolored beauty. Diamonds with a D color grade are the most rare and expensive on the market, with a significant price premium over other color grades.",
  },
  {
    type: "E",
    description:
      "E color diamonds look almost identical to D color diamonds. Most of the time, the differences in color between a D and E diamond are only visible to an expert gemologist when the two diamonds are viewed under magnification.<br/><br/> Like D color diamonds, E color diamonds are usually set in platinum or white gold to avoid the color of the jewelry detracting from their near flawless color. Although these diamonds are less expensive than D color diamonds, they still command a hefty premium.",
  },
  {
    type: "F",
    description:
  ...
  },
  {
    type: "G",
    description:
      "G color diamonds exhibit nearly no color and appear primarily colorless to the naked eye. The G color grade is the highest, best grade in the “Near Colorless” range of the GIA’s scale, which covers diamonds graded G to J.<br/><br/> Although G color diamonds have some tints of color, they’re almost impossible to detect with the naked eye. Like D-F diamonds, these diamonds should be set in platinum or white gold to reduce any effects of color reflection from yellow or rose gold.",
  },
  {
    type: "H",
    description:
      "H color diamonds appear primarily colorless to the naked eye but have a faint yellow hue that’s often visible under magnification in bright lighting, especially when they’re compared to diamonds of a higher color grade.<br/><br/> Like G color diamonds, these can be set in platinum or white gold without any issues. H color diamonds are slightly less expensive than G color diamonds and significantly more affordable than diamonds in the colorless range. This is the minimum color grade we recommend for diamond shapes with a large table, such as the radiant and cushion cuts.",
  },
  {
    type: "I",
    description:
      "I color diamonds offer a great combination of near colorless looks and good value for money. These diamonds have a slight yellow tint that’s usually only visible when they’re viewed next to diamonds of a higher color grade.<br/><br/> An I color round brilliant cut diamond can look fantastic in a platinum or white gold setting, as well as alongside metals such as yellow or rose gold. As you’d expect, I color diamonds are less expensive than G or H color diamonds. This is the minimum color grade we recommend for princess cut diamonds.",
  },
  {
    type: "J",
    description:
      "J color diamonds look mostly colorless to the naked eye, but usually have a faint yellow tint that’s easy to notice under bright lights and magnification. In diamonds with a large table, the color might also be visible with the naked eye in certain lighting conditions.<br/><br/> From a value for money perspective, J color diamonds can be fantastic choices. We recommend this color for round brilliant cut diamonds set in platinum or white gold (solitaire setting), as the cut of the round diamond is great at concealing color. However, the J color grade is not recommended for diamond shapes with a larger table and fewer facets.",
  },
  {
    type: "K",
    description:
      "K color diamonds are classed as “faint tint” on the GIA’s diamond color scale, meaning they have a slight yellow tint that’s visible even to the naked eye.<br/><br/> Diamonds in this price range can be found for significantly less than those in the G to J range. Set in a beautiful yellow gold setting, a K color round brilliant cut diamond can look gorgeous. However, diamonds of this color grade should generally not be set in platinum or white gold.",
  },
  {
    type: "L",
    description:
      "L color diamonds have a yellow tint that’s visible to the naked eye in normal lighting conditions. Diamonds with this color grade are much more affordable than those in the G to J range, making them a good value for money option.<br/><br/> Because of the yellow tint, we don’t recommend the L color grade for non-round diamond shapes. We also don’t recommend it for diamonds set in platinum or white gold. However, L color round brilliant cut diamonds can still look great in yellow gold solitaire rings due to the warm, yellow tone of the metal.",
  },
  {
    type: "M",
    description:
      "M color diamonds have a definite yellow tint that’s visible to the naked eye. Like K and L diamonds, M color diamonds offer fantastic value for money when compared to near colorless or colorless diamonds.<br/><br/> The M color grade is typically the lowest color grade offered by online diamond vendors. Although M color diamonds can look warm and beautiful in antique yellow gold settings, their color is quite easy to notice even with the naked eye.",
  },
  {
    type: "N-R",
    description:
...
export const colorBottomLineRec = "";
export const colorBottomLineRecWhatToLookFor = [
...
export const colorBottomLineRecWhatToAvoid = [
