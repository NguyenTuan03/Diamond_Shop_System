...
export default function DriverProvider({ children }) {
    ...
    const driverObj = driver({
        ...
        steps: [
            ...
            { element: '.step6', popover: { title: 'Make request', description: 'You can valuation your diamond here', side: "right", align: 'start' }},
            { element: '.step7', popover: { title: 'Thank you😊', description: 'Enjoy your valuating diamond time at our website! 🙌', side: "right", align: 'start' }},
        ]
    });
