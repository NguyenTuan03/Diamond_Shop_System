...
import com.valuatediamond.diamond_shop.repository.EmailSender;
...
public class RegistrationService {
    ...
    public String confirmToken(String token) {
        TokenEntity confirmationToken = confirmationTokenService
                .getToken(token)
                .orElseThrow(() ->
        ...
        accountService.enableAccountByEmail(confirmationToken.getAccountEntity().getEmail());
        return "Confirmed";
    }
